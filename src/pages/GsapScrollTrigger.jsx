    ...
    () => {
      ...
      boxes.forEach((box) => {
        gsap.to(box, {
          ...
          scale: 1.5,
          scrollTrigger: {
            // animation will be triggered when one box comes to the viewport
            trigger: box,
            // When the bottom of the trigger hits the bottom of the viewport, it will trigger the animation
            start: "bottom bottom",
            // It will end when top of the box hit the 20% of the viewport
            end: "top 20%",
            scrub: true,
          },
          ease: "power1.inOut",
